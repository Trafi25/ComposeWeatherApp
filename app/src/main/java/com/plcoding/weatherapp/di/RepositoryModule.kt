...
import com.plcoding.weatherapp.data.repository.WeatherAiRepositoryImpl
...
abstract class RepositoryModule {
    ...
    @Binds
    @Singleton
    abstract fun bindWeatherAiRepository(impl: WeatherAiRepositoryImpl): WeatherAiRepository
}
