...
class WeatherViewModel @Inject constructor(
    ...
    private fun observeSelectedLocation() {
        viewModelScope.launch {
            selectedLocationRepository.observeSelectedCityId()
    ...
    private fun loadWeatherForCity(lat: Double, lon: Double, name: String, id: Int) {
        weatherLoadingJob?.cancel()
        aiSummaryJob?.cancel()
        weatherLoadingJob = viewModelScope.launch {
            _uiState.update { it.copy(
    ...
    private suspend fun fetchWeather(lat: Double, lon: Double, locationName: String, cityId: Int?) {
    ...
    private fun generateAiSummary(weatherInfo: WeatherInfo, locationName: String, lat: Double, lon: Double) {
        aiSummaryJob?.cancel()
